...
\section{Discussion}
With the help of the CALMS model, specifically the factors \texit{Culture, Automation and Sharing}, we were able to process these insights and conduct affinity and scenario mapping. We used an affinity map to categorize the different types of support needed. %pink qualitative answers. 
...
\begin{figure}[tp]
    ...
    \caption{Preview of \texit{Grit} and some of its features}
    \label{fig:mockup}
\end{figure}
